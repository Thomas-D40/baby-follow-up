...
// typed millilitres by contract and read both by the 🍼 chip and by the bottle label: carrying a
// temperature in it would break the bottle SILENTLY. Hence a dedicated
// `temperatureCelsiusX10`, null for every other event type.
